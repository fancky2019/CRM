...
{
    public partial class MemberAmountStatistic : XtraUserControl
    {
        StatisticsReportBll _bll = null;
        public MemberAmountStatistic()
        {
            InitializeComponent();
        ...
        {
           var result = _bll.MemberAmountStatistic(new MemberAmountQM()
            {
                Skip = skip,
                Take = take
            });
        ...
        {
            MemberAmountQM qm = new MemberAmountQM();
            qm.Skip = 0;
